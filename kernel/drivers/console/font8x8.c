 ...
 * RESENTMENT kernel - 8x8 console font.
 *
 * Public domain 8x8 bitmap font by Daniel Hepper, derived from the IBM VGA
 * fonts via Marcel Sondaar. https://github.com/dhepper/font8x8
 *
 * Rows are bottom-to-top-agnostic bitmaps with bit 0 as the leftmost pixel,
 * which is why the framebuffer console tests (byte >> x) & 1 rather than the
 * more usual high bit first.
 */
#include <rk/types.h>

const u8 rk_font8x8[128][8] = {
